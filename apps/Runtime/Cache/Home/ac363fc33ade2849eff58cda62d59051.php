...
<head>
  ...
  <link rel="stylesheet" href="Public/love-life/css/wap.css">
  <title>视频列表页</title>
</head>
              ...
              <ul class="am-list">
                ...
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_topci_list">
                  <a href="###" class="pet_topci_block">
                    ...
                    <img src="Public/love-life/img/c8.png" alt="">
                  </a>
                </li>
                                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_topci_list">
                  <a href="###" class="pet_topci_block">
                    ...
                    <div class="pet_topci_shadow"></div>
                    <img src="Public/love-life/img/c7.png" alt="">
                  </a>
                </li>
                                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_topci_list">
                  <a href="###" class="pet_topci_block">
                    ...
                    <div class="pet_topci_shadow"></div>
                    <img src="Public/love-life/img/c5.png" alt="">
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_topci_list">
                  <a href="###" class="pet_topci_block">
                    ...
                    <div class="pet_topci_shadow"></div>
                    <img src="Public/love-life/img/c3.png" alt="">
                  </a>
                </li>
                ...
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_topci_list">
                  <a href="###" class="pet_topci_block">
                    ...
                    <div class="pet_topci_shadow"></div>
                    <img src="Public/love-life/img/c6.png" alt="">
                  </a>
                </li>
